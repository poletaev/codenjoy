...
import com.codenjoy.dojo.codingbattle2019.services.Events;

import java.util.*;

import static com.codenjoy.dojo.services.PointImpl.pt;

public class CodingBattle2019 implements Field {
    ...
    public CodingBattle2019(Level level, Dice dice, int ticksToRecharge, int bulletsCount) {
        this.dice = dice;
    ...
    public BoardReader reader() {
        return new BoardReader() {
            private int size = CodingBattle2019.this.size;
